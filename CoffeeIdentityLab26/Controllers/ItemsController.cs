...
namespace CoffeeIdentityLab26.Controllers
{
    ...
    {
        private CoffeeShopIdentityEntities db = new CoffeeShopIdentityEntities();
        ...
        public ActionResult Create([Bind(Include = "ItemID,ItemName,Description,Price")] Item item)
        {
